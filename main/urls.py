...
urlpatterns = [
    ...
    # path('disclaimer', disclaimer, name='{% url 'disclaimer' %}'),
    ...
    path('contact/details', ContactDetailsView.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy','post': 'create', 'get': 'list'}), name='ContactDetailsView'),
    path('androiddata', AndroidDataView.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy','post': 'create', 'get': 'list'}), name='androiddata'),
]
